...
<Tab title="OpenCode">
    ...
    ``json lines theme={null}     {       "mcp": {         "openrouter": {           "type": "remote",           "url": "https://mcp.openrouter.ai/mcp",           "enabled": true         }       }     }     ``
  

  <Tab title="Cursor CLI"></tab>
    ...
    ``json lines theme={null}     {       "mcpServers": {         "openrouter": { "url": "https://mcp.openrouter.ai/mcp" }       }     }     ``
  

  <Tab title="Claude Desktop / Web"></tab>
    ...
    <Note>        Some organizations don't allow adding custom connectors, so this option may not appear for everyone. If you don't see it, talk to your admin.    </Tabs>
